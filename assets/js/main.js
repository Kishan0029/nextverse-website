...
(function ($) {
    ...
    var cursorTrail = () => {
        ...
        function draw() {
            ...
            // Shrink the trail if idle for 2 seconds
            if (Date.now() - lastMoveTime > 2000 && points.length > 0) {
                points.shift();
            }
...
$(document).ready(function() {
    $("a").on("click", function(e) {
        ...
        if (href && !href.startsWith("#") && !href.startsWith("javascript:") && target !== "_blank" && (href.indexOf(window.location.host) !== -1 || !href.startsWith("http"))) {
            e.preventDefault();
